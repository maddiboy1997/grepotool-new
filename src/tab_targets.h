#ifndef ___TARGET_BROWSER_H
#define ___PTARGET_BROWSER_H
/* tab_targets.h  - Target list widget
...
class TabTargets: public TableTool {
	Q_OBJECT;
...
public slots:
	...
	void setTargetTown (int, UnitIndex );
	void editDateTime  ();
	void townInfoChanged (int );
	void tabSelChg ();

signals:
	void currentSelectionChangedSignal(int);
