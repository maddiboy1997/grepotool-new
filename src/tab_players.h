#ifndef ___PLAYERS_BROWSER_H
#define ___PLAYERS_BROWSER_H
/* tab_players.h  - Player list widget
...
class TabPlayers : public TableTool {
	Q_OBJECT;
...
public:
	...
	void           setItemCheckState (int, bool);
...
public slots: 
	void setAlly (int i) { setRootIndex (i); };
	void showPlayersWithoutAlly () { setRootIndex (-1); };
